        ...
        <Modal show={show}
          ...
          <Modal.Body className='white-space: pre-line'  style={{display: 'flex', alignItems: 'center' }}>
            <Container className='disclaimer-container'>
              ...
              <Row className="m-3">
                By using our website, you acknowledge that you have read, understood, and agreed to this disclaimer regarding the use of the WhatsApp API.
              </Row>
            </Container>
          </Modal.Body>
          <Modal.Footer>
